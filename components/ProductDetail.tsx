  ...
  useEffect(() => {
    ...
    const generateAIDescription = async () => {
      try {
        ...
        setAiDescription(data.text || "Eksklyuziv dizayn va yuqori sifat uyg'unligi. Ushbu mahsulot sizning stilingizni yangi darajaga olib chiqadi.");
      } catch (error) {
      ...
      <Helmet>
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "description": product.shortDescription || aiDescription,
            "brand": {
              "@type": "Brand",
              "name": "LUXECORE"
            },
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16 mb-12">
          ...
          >
            <div className="sticky top-24 md:top-28 space-y-4">
              <div className="aspect-square w-full rounded-2xl md:rounded-3xl overflow-hidden border border-white/5 shadow-2xl bg-dark-800 relative group">
          ...
          >
            <div className="space-y-3 md:space-y-4 mb-6 md:mb-8">
              ...
              <h1 className="text-2xl md:text-3xl lg:text-4xl font-bold leading-tight bg-clip-text text-transparent bg-gradient-to-br from-white to-gray-400">
                {product.name}
              </h1>
            ...
            <div className="py-6 md:py-8 border-t border-white/10 border-b border-white/10 mb-6 md:mb-8">
              <div className="flex items-end justify-between mb-4 md:mb-6">
                <div>
                  ...
                  <p className="text-xl md:text-2xl font-light text-white">{product.formattedPrice}</p>
                </div>
                <button
