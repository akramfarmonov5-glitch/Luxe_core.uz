    ...
    <section className="relative min-h-screen flex items-center pt-24 md:pt-20 overflow-hidden">
      ...
      <div className="container mx-auto px-4 md:px-6 grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 items-center z-10">
        ...
        >
          ...
          <p className="text-gray-400 text-base md:text-xl max-w-lg font-light leading-relaxed">
          ...
          <div className="flex gap-4 pt-2 md:pt-4">
            <button 
              ...
              className="flex items-center gap-2 px-6 py-3 md:px-8 md:py-4 bg-white text-black font-semibold rounded-full hover:bg-gold-400 hover:text-black transition-all duration-300 transform hover:scale-105 text-sm md:text-base"
            >
              {displayContent.buttonText}
              <ArrowRight size={18} />
            </button>
            <button className="px-6 py-3 md:px-8 md:py-4 border border-white/20 text-white font-medium rounded-full hover:bg-white/10 backdrop-blur-sm transition-all duration-300 text-sm md:text-base">
              Batafsil
            </button>
          </div>
        </motion.div>
        ...
        <div className="relative h-[400px] md:h-[650px] w-full order-1 lg:order-2">
            ...
            <div className="relative h-full w-full rounded-[2rem] md:rounded-[2.5rem] overflow-hidden border border-white/10 shadow-2xl bg-dark-900">
