...
const testimonials: Testimonial[] = [
  {
    ...
    rating: 5,
    text: {
      uz: 'LUXECORE dan birinchi marta buyurtma berdim va juda mamnunman! Yetkazib berish tez bo\'ldi, mahsulot sifati ajoyib. Albatta yana xarid qilaman.',
      ru: 'Впервые заказала в LUXECORE и очень довольна! Доставка была быстрой, качество товара отличное. Обязательно закажу еще.',
      en: 'First time ordering from LUXECORE and I\'m very satisfied! Fast delivery, great product quality. Will definitely order again.',
    },
  ...
  },
  {
    ...
    rating: 5,
    text: {
      uz: 'Narxlari boshqa do\'konlarga nisbatan ancha qulay. Premium qutisi ham juda chiroyli bo\'lgan. Xizmat ko\'rsatish darajasi yuqori!',
      ru: 'Цены значительно выгоднее, чем в других магазинах. Упаковка тоже была очень красивой. Высокий уровень обслуживания!',
      en: 'Prices are much more affordable than other stores. The premium box was beautiful too. High level of service!',
    },
  ...
  },
  {
    ...
    rating: 5,
    text: {
      uz: "Sovg'a uchun soat buyurtma berdim. Sifati zo'r, ko'rinishi juda premium. Katta rahmat LUXECORE jamoasiga!",
      ru: 'Заказал одноразовую посуду для ресторана. Отличное качество, доступная цена. Большое спасибо команде LUXECORE!',
      en: 'Ordered a watch as a gift. Excellent quality and a truly premium look. Thank you LUXECORE team!',
    },
